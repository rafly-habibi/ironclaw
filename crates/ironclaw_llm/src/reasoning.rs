...
impl Reasoning {
    ...
    pub fn with_platform_info(mut self, info: ironclaw_common::PlatformInfo) -> Self {
...
{{
    ...
    pub fn build_system_prompt_with_tools(&self, tools: &[ToolDefinition]) -> String {
        ...
        let needs_tags = self
            .model_name
            .as_ref()
            .is_some_and(|n| crate::reasoning_models::requires_think_final_tags(n));
...
That's my plan."#;
    ...
    async fn test_respond_with_tools_flags_empty_tool_completion_when_content_is_none() {
        ...
        impl LlmProvider for NoneContentToolLlm {
            ...
            ) -> Result<crate::CompletionResponse, crate::LlmError> {
            ...
            ) -> Result<ToolCompletionResponse, crate::LlmError> {
...
<tool_call>{"name": "verify"}"#;
    ...
    impl crate::LlmProvider for TruncatingLlm {
        fn model_name(&self) -> &str {
            "truncating-stub"
        }
        ...
        async fn complete_with_tools(
            &self,
            _request: crate::ToolCompletionRequest,
        ) -> Result<crate::ToolCompletionResponse, crate::error::LlmError> {
            Ok(crate::ToolCompletionResponse {
